...
func RegisterAdminRoutes(e *echo.Echo, db *mongo.Database, hub *websocket.Hub) {
	...
	protected.GET("/salespersons/:id/subscription-payments", adminController.GetSalespersonSubscriptionPayments)
	...
	protected.GET("/whish-payments", adminController.GetWhishPaymentDetails)
